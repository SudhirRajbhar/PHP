...
<div class="form-group">
<button class="btn btn-outline-primary btn-block" name="submit" value="<?php echo $_SESSION['pid']; ?>"type="submit">PAY</button>
</div>
...
$sql="insert into transaction(bookingid,pid,ctype,cno,amount,name,expiry,cvv)values($bid,$pid,'$ctype','$cno','$amount','$cname','$exp',$cvv)";
$sql2="update booking set status='paid' where bookingid=$bid";

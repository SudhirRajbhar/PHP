...
class="col-md-5 text-uppercase "><h1>Welcome <span class="text-info"><?php echo $r['name']?><span></h1></div> <div class="col-md-6"></div> <div class="col-md-1"> <a href="logout.php"><button class="btn
...
<li class="nav-item"><a href="transaction.php" class="nav-link">View Transaction</a></li>
		...
		<div class="col-md-8 p-4">
			<?php 
$obj=new operation();
$sq="select * from tested where pid=$pid";
if($a=$obj->view($sq))
{
			 ?>
<embed src="images/<?php echo $a['report'] ?>" style="height:500px;width:800px"></embed>

	<?php }
else 
{
echo "<h2>Report Not Uploaded Yet ! <br> Please Wait until Doctor will Not Upload Your Report</h2>";

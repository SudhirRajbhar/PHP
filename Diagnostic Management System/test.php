...
<table class="table table-hover table-striped table-borderless">
	<tr><th>Report Id</th><th>Booking Id</th>
		<th>Patient Name</th><th>Email</th><th>Mobile</th><th>Tests </th>
		<?php
include("operation.php");
		 $obj=new operation();
	$sql2="select * from tested";
	$p=$obj->selectall($sql2);
	while($a=$p->fetch_assoc())
	{ ?>
	</tr>
	<tr><td><?php echo $a['reportid'] ?></td>
<td><?php echo $a['bookingid'] ?></td>
<td><?php echo $a['name'] ?></td>
<td><?php echo $a['email'] ?></td>
<td><?php echo $a['mob'] ?></td>

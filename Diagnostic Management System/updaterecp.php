...
<div class="container-fluid mt-4">
	<div class="row mt-4">
		<div class="col-md-4"></div>
		<div class="col-md-4 ">
<form action="updaterecp2.php" method="post">
...
<tr><td colspan="2" class="text-center"><button type="submit" name="id" value="<?php echo $r['rid']; ?>" class="btn btn-outline-primary">UPDATE</button></td></tr>
			</TABLE></form>
		</div>
		<div class="col-md-4"></div>
	</div>
